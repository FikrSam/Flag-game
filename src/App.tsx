...
export function App() {
  ...
  return (
    <div className="h-[100dvh] w-screen max-w-full bg-[#0a0a0a] text-[#f8fafc] flex flex-col overflow-hidden">
      {/* Header */}
      <Header
      ...
      <main className="flex-1 w-full h-[calc(100dvh-44px)] md:h-[calc(100dvh-50px)] min-h-0 flex flex-col md:flex-row gap-1.5 sm:gap-2 md:gap-3 p-1.5 sm:p-2 md:p-3 overflow-hidden">
        ...
        <section className="relative flex-1 min-h-[220px] w-full h-full flex flex-col overflow-hidden rounded-lg border border-[#1e1e1e] bg-[#0a0a0a]" aria-label="Map Canvas">
          ...
          {wrongFeedback && (
            <div className="absolute top-3 left-1/2 -translate-x-1/2 z-30 pointer-events-none animate-fade-in">
              <div className="px-4 py-1.5 bg-rose-950/90 border border-rose-500/60 text-rose-100 text-xs font-semibold rounded-lg shadow-[0_4px_20px_rgba(0,0,0,0.4)] backdrop-blur-md flex items-center gap-1.5">
